...
\begin{tikzpicture}
    [block/.style ={rectangle,draw=red!50,fill=red!20,minimum size=4mm,align=center},
     ...
     every label/.style={font=\small,text width=1.25cm,align=center}
    ]
    ...
    \node[tensor={18pt}{\the\cellsize}{blue}] (latent) [right=of layer3] [label=below:$1 \times n_f$] {}
        ...
        ;
    \node[tensor={\the\cellsize}{18pt}{orange}] (flat latent) [right=of latent] [label=below:$n_f \times 1$] {}
    ...
    \node[tensor={\the\cellsize}{18pt}{red}] (latent2) [right=0.5cm of aggregate] [label=below:(latent)\\$n_f \times 1$] {}
        edge ["fc1",{Latex}-] (aggregate)
        ;
        
    \node[circle,fill,inner sep=1pt] (split) [right=0.5cm of latent2] {};
        
    \node (sigma) [right=3.25cm of flat latent]  {$\sigma$};
    \node (mu) [right=3.25cm of embedding]  {$\mu$};
